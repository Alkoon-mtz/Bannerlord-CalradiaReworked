...
<!-- Scarhok -->
    ...
    <xsl:template match="string[@id='str_adjective_for_faction.vlandia']/@text"> <xsl:attribute name="text">Scarhokar</xsl:attribute> </xsl:template>
    ...
    <xsl:template match="string[@id='str_faction_informal_name_for_culture.vlandia']/@text"> <xsl:attribute name="text">the Scarhokars</xsl:attribute> </xsl:template>
